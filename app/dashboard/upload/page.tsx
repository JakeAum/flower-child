...
export default function Upload() {
  ...
  const handleSubmit = (e) => {
    ...
    // Need to learn how to write Images to Supabase Buckets, then get the URL form the Image as a CDN
    // NOTE: is it quicker for the client to get
  };
  ...
  return (
    <>
            ...
            <div className="card-body h-[calc(100vh-2rem-64px)] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit}>
                <div className="form-control mb-4">
                  ...
                  <input
                    type="text"
                    id="plantMaterialName"
                    value={formData.plantMaterialName}
                ...
                <div className="form-control mb-4">
                  <label className="label cursor-pointer">
                    <span className="label-text">
                      Is this known to be Toxic?
                    </span>
                    <input
                      type="checkbox"
                      id="toxic_bool"
                      checked={formData.toxic_bool}
                      onChange={handleInputChange}
                ...
                <div className="form-control mb-4">
                  ...
                  <textarea
                    id="toxic_note"
                    value={formData.toxic_note}
                    onChange={handleInputChange}
                    className="textarea textarea-bordered h-24"
                    placeholder="Enter toxic note"
                  ></textarea>
                </div>
                ...
                <div className="form-control mb-4">
                  <label className="label">
                    <span className="label-text">
                      Upload an Image of the Specimen
                    </span>
                  </label>
                  <input
                    type="file"
            ...
            <div className="modal-box w-11/12 max-w-5xl w-full">
              ...
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="w-full text-left">
                  ...
                  <p className="text-lg">
                    <strong>Common Names:</strong> {formData.commonNames}
                  </p>
                  <p className="text-lg">
                    <strong>Notes:</strong> {formData.information}{" "}
                    {formData.toxic_note}
                  </p>
                  <p className="text-lg">
                    <strong>Located:</strong> {formData.shelfNumber}
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* Button Linking Back to Admin Dashboard*/}

      <div className="flex justify-center bg-base-200 p-4">
        <Link href="/dashboard" passHref>
          <button className="btn btn-accent btn-wide">Return to Dashboard</button>
        </Link>
      </div>
